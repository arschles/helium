...
class App {
     ...
     */
    constructor(projectID, projectNS) {
        /**
        ...
        this.proj = new events.Project();
        // true if the "after" event has fired.
        this.afterHasFired = false;
        this.storageIsDestroyed = false;
        /**
